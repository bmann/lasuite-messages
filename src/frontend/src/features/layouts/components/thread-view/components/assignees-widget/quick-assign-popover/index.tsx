...
export const QuickAssignPopover = ({
  ...
  const { assignedUserIds, mutatingUserIds, assignUser, unassignUser } =
    useThreadAssignment();

  const accessesQuery = useThreadsAccessesList(threadId, undefined, {
    ...
    >
      ...
      >
        ...
        >
            ...
            <Menu
              ...
              renderEmptyState={() =>
                accessesQuery.isLoading ? (
                  ...
                  >
                    <Spinner size="sm" />
                    <span className="c__offscreen">{t("Loading users")}</span>
                  </div>
                ) : (
          ...
          <div role="status" aria-live="polite" className="c__offscreen">
            {announcement}
          </div>
        </div>
      </Dialog>
